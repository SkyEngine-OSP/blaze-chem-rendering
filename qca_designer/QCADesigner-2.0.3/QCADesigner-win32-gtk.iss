...
LicenseFile=/usr\share\doc\QCADesigner-2.0.3\COPYING
...
[Files]
Source: "/usr\*"; DestDir: "{app}"; Flags: recursesubdirs
Source: "/home/jeff/dev/dev_apps/sand/qca_designer/QCADesigner-2.0.3\gtk-runtime-2.6.8-rev-a.exe"; DestDir: "{tmp}"; Flags: dontcopy
