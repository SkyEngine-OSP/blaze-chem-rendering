...
BuildRequires:  treecc >= 0:0.3.4
BuildRequires:  pnet-interpreter >= 0:0.8.0
BuildRequires:  pnet-compiler >= 0:0.8.0
BuildRequires:  pnet-tools >= 0:0.8.0
BuildRequires:  XFree86-devel

Requires:       pnet-interpreter >= 0:0.8.0
Requires:       pnet-tools >= 0:0.8.0
