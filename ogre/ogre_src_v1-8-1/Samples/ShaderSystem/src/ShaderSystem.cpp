...
//static float redCount = 0.0;
//static float blueCount = 0.0;
//static float greenCount = 0.0;
...
void Sample_ShaderSystem::createSpotLight()
{
	...
	static float greenCount = 0.0;
	static float blueCount = 0.0;
	int index = 100000;float dt = 1/index;
	int clock = 1;
...
while(index >= 1){
	...
	redCount = redCount + dt;
	greenCount = greenCount + dt;
	blueCount = blueCount + dt;

	light->setDiffuseColour(.5,.2, .1);
	light->setSpecularColour(0.5, 0.5, 0.5);	
